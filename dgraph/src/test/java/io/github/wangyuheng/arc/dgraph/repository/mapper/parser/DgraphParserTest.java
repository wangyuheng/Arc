...
import io.github.wangyuheng.arc.dgraph.util.UnionClasses;
...
public class DgraphParserTest {
    ...
    public void union_class_should_get_domain_class() {
        ...
        String jsonString = "{\n" +
                ...
                "    \"unionField\":{\n" +
                "        \"id\":\"asdgg1\",\n" +
                "        \"domainClass\":\"io.github.wangyuheng.arc.dgraph.repository.mapper.parser.DgraphParserTest$B\"\n" +
                "    },\n" +
                "    \"UnUnionField\":{\n" +
                "         \"id\":\"asdav14\",   \n" +
                "         \"unionField\":{\n" +
                "             \"id\":\"bvlhj1\",\n" +
                "             \"domainClass\":\"io.github.wangyuheng.arc.dgraph.repository.mapper.parser.DgraphParserTest$C\"\n" +
                "         }\n" +
                "    }\n" +
                "}";
